...
if ( ! class_exists( 'Timber_Acf_Wp_Blocks' ) ) {
    ...
    class Timber_Acf_Wp_Blocks {
        ...
        public function __construct() {
            ...
            if (!defined('WKN_TIMBER_ACF_WP_BLOCKS_DISABLE_NOTICE') || !WKN_TIMBER_ACF_WP_BLOCKS_DISABLE_NOTICE){
                add_action( 'admin_notices', function () {
                    echo '<div class="notice notice-warning is-dismissible"><p>Le plugin composer wokine/timber-acf-wp-blocks ne doit plus être utilisé car il utilise des fonctions deprecated d\'ACF.</p> </div>';
                });
            }
        }
